...
def Generate_Brain():
  ...
  pyrosim.Send_Sensor_Neuron(name=1, linkName="BackLeg")    # Sensor neuron for BackLeg
  pyrosim.Send_Sensor_Neuron(name=2, linkName="FrontLeg")    # Sensor neuron for FrontLeg
  # ---------------- New Motor Neurons -----------------
